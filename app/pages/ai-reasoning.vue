...
<template>
  <div class="mx-auto px-8 py-8 flex flex-col gap-4 max-w-lg">
    ...
    <div class="flex w-full max-w-lg flex-col gap-4">
      ...
      >
        ...
        <ItemContent>
          <ItemTitle class="text-base">
            {{ aiResultState?.cardTitle }}
          </ItemTitle>
          <div
            v-if="aiResultState?.rateDelta !== undefined && aiResultState?.rateDelta < 0"
      ...
      <div class="p-2">
        <ChartReasoning
          v-if="aiResultState !== null && pastData !== null"
          :card-title="aiResultState.cardTitle"
          :rate-delta="aiResultState.rateDelta"
          :chart-array="aiResultState.chartArray"
          :past-data="pastData.finalArray"
        />
      </div>
    </div>
