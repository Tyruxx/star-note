...
<template>
  ...
  >
    <slot>
      <div
        v-if="!nestLabel && tooltipLabel && upperLower?.[tooltipLabel] !== undefined"
        class="font-medium"
      >
        {{ tooltipLabel }} (Predicted Rate)
      </div>
      <div
        v-else-if="!nestLabel && tooltipLabel && upperLower?.[tooltipLabel] === undefined"
        class="font-medium"
      >
        {{ tooltipLabel }}
      </div>
      <div class="grid gap-1.5">
        ...
        >
          ...
          <div class="flex flex-col w-full">
            ...
            <div
              v-if="upperLower?.[tooltipLabel] !== undefined"
            ...
            >
              ...
              <span
                v-if="(upperLower[tooltipLabel]?.[0] ?? 0) >= 10"
                class="text-foreground font-mono font-medium tabular-nums"
              >
                {{ upperLower[tooltipLabel]?.[0].toFixed(2) }}
              </span>
              <span
                v-else-if="(upperLower[tooltipLabel]?.[0] ?? 0) < 10"
                class="text-foreground font-mono font-medium tabular-nums"
              >
            ...
            >
              ...
              <span
                v-if="(upperLower[tooltipLabel]?.[1] ?? 0) >= 10"
                class="text-foreground font-mono font-medium tabular-nums"
              >
                {{ upperLower[tooltipLabel]?.[1].toFixed(2) }}
              </span>
              <span
                v-else-if="(upperLower[tooltipLabel]?.[1] ?? 0) < 10"
                class="text-foreground font-mono font-medium tabular-nums"
              >
